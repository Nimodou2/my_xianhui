...
public class WorkRefreshListView extends ListView implements OnScrollListener{
	...
	public WorkRefreshListView(Context context) {
		super(context);
		init();
	}

	public WorkRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
