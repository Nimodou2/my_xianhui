...
//                Log.e("getUserList:",response);
    ...
    //获取ConversationID
    public void getConversationIDFromService(String apiURL, String token, String guid) {
        OkHttpUtils
                .post()
                ...
                .execute(new StringCallback() {
                    ...
                    @Override
                    public void onResponse(String response, int id) {
                        Log.e("LoginGetConverId:", response);
                        JsonObject jsonObject = new JsonParser().parse(response).getAsJsonObject();
                        List<String> list_conver = new ArrayList<String>();
                        String status = "";
                        String message = "";
