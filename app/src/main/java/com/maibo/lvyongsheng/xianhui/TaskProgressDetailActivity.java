...
public class TaskProgressDetailActivity extends Activity implements View.OnClickListener{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    ...
                    //此处在Listview中展示数据
                    //第一次进入时展示的是顾问相关数据
                    lv_item_list.setAdapter(new TaskProgressDetailAdapter(getApplicationContext(),TaskProgressDetailActivity.this,tkInfor.getAdviser_list()));
                    showDatas();
                    break;
                case 1:
                    //此处缺少最后三项数据
                    ...
                    case R.id.rb_technician:
                        ...
                        if (isHaveData==1){
                            if (tkInfor.getEngineer_list().size()>0){
                                lv_item_list.setAdapter(new TaskProgressDetailAdapter(getApplicationContext(),TaskProgressDetailActivity.this,tkInfor.getEngineer_list()));
                            }
                        }
                    ...
                    case R.id.rb_customer:
                        ...
                        if (isHaveData==1){
                            if (tkInfor.getCustomer_list().size()>0){
                                lv_item_list.setAdapter(new TaskProgressDetailAdapter(getApplicationContext(),TaskProgressDetailActivity.this,tkInfor.getCustomer_list()));
                            }
                        }
