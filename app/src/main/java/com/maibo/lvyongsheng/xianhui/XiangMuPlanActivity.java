 ...
 */
public class XiangMuPlanActivity extends Activity {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    ...
                    //展示项目计划和产品计划
                    planItem.setAdapter(new XiangMuPlanAdapter(XiangMuPlanActivity.this,listArray1,listArray2));
                    break;
            }
        }};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(XiangMuPlanActivity.this,AddTabActivity.class);
