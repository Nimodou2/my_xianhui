 ...
 */
public class YuyueMessageActivity extends Activity {
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            //传递给适配器
            LinearLayoutManager llm=new LinearLayoutManager(YuyueMessageActivity.this);
            rv_yuyue.setLayoutManager(llm);
            rv_yuyue.addItemDecoration(new AllDividerDecoration(YuyueMessageActivity.this));
    ...
    class MyRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        MyRecyclerViewAdapter(List<LastData> lists){
            this.lists=lists;
            inflater=LayoutInflater.from(YuyueMessageActivity.this);
        }
