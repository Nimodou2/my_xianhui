...
public class RefreshListView1 extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.list_view_head, null);
    ...
    /**
     * 当滚动状态改变时回调
     * 1、SCROLL_STATE_IDLE：当屏幕停止滚动时
     * 2、SCROLL_STATE_TOUCH_SCROLL：是当用户在以触屏方式滚动屏幕并且手指仍然还在屏幕上时
     * 3、SCROLL_STATE_FLING：当用户由于之前划动屏幕并抬起手指，屏幕产生惯性滑动时
     */
    @Override
